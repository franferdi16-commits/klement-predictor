...
# Grupos verificados con el sorteo oficial FIFA del 5 de diciembre de 2025

TEAMS = {
    # ── GRUPO A ── Sede principal: México/Guadalajara/Atlanta/Monterrey
    ...
    # ── GRUPO B ── Sede principal: Toronto/San Francisco/Los Ángeles/Vancouver
    ...
    # ── GRUPO C ── Sede principal: Boston/Miami/New York
    ...
    # ── GRUPO D ── Sede principal: Los Ángeles/Seattle/Vancouver/San Francisco
    ...
    # ── GRUPO E ── Sede principal: Houston/Toronto/Filadelfia/New York
    ...
    # ── GRUPO F ── Sede principal: Dallas/Monterrey/Houston/Kansas City
    ...
    # ── GRUPO G ── Sede principal: Seattle/Los Ángeles/Atlanta/Vancouver
    ...
    # ── GRUPO H ── Sede principal: Atlanta/Miami/Houston/Zapopan
    ...
    # ── GRUPO I ── Sede principal: New York/Boston/Toronto/Filadelfia
    ...
    # ── GRUPO J ── Sede principal: Kansas City/Dallas/Filadelfia
    ...
    # ── GRUPO K ── Sede principal: Miami/Atlanta/Houston/Zapopan
    ...
    # ── GRUPO L ── Sede principal: Filadelfia/New York/Boston/Dallas
...
# ── GENERACIÓN AUTOMÁTICA DEL FIXTURE (72 partidos, round-robin por grupo) ──
FIXTURE = []
match_id = 1

grupos = ["A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "K", "L"]
for g in grupos:
    eq = [name for name, info in TEAMS.items() if info["grupo"] == g]
    # Combinaciones oficiales FIFA para 4 equipos (3 jornadas × 2 partidos)
    combinaciones = [
        (eq[0], eq[1]), (eq[2], eq[3]),   # Jornada 1
        (eq[0], eq[2]), (eq[3], eq[1]),   # Jornada 2
        (eq[3], eq[0]), (eq[1], eq[2]),   # Jornada 3
    ]
